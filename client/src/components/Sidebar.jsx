                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="relative py-2 group">
                        ...
                        <div className="absolute top-full right-0 z-20 w-32 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block shadow-lg">
                            ...
                            <p onClick={()=> logout()} className="cursor-pointer text-sm hover:bg-gray-700 px-3 py-2">Logout</p>
                        </div>
                    </div>
                </div>
...
{unseenMessages?.[user._id] > 0 && 
  <p className='absolute top-4 right-4 text-4 text-xs h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/50'>
