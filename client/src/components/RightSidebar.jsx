...
const RightSidebar = ({ selectedUser }) => {
  return selectedUser && (
    <div className="bg-[#8185B2]/10 text-white w-full relative overflow-y-auto max-md:hidden">
      ...
      {/* Logout Button */}
      <button className="absolute bottom-5 left-1/2 -translate-x-1/2 transform bg-gradient-to-r from-purple-500 to-violet-600 text-white text-sm font-medium py-2 px-8 rounded-full hover:opacity-90 transition">
        Logout
      </button>
    </div>
  );
